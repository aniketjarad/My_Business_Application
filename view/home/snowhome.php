...
$counts = $this->getAllCountGeneric("Servicenow");
?>
<!-- Content Header (Page header) -->
 <div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h4 class="m-0 text-dark">ServiceNow</h4>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="/home/snowhome">Home</a></li>
          <li class="breadcrumb-item active">ServiceNow</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
      ...
      <div class="card card-success" style="" id="CertificateChart" >
            ...
            <div class="card-body">
              ...
              <div class="chart" id="servicenowPieChart">
                ...
                <canvas id="servicenowCertificateBarChart" width="150" height="100" class="chartjs-render-monitor"></canvas>
              </div>
            </div>
            <!-- /.card-body -->             
        </div>
