        ...
        <tbody style="font-size: 11px;text-align:center;">
            <?php 
				...
				<tr>
					...
					<td><?php if(!empty($emp_data['jd'])) { echo "<a download=".end(explode("/",$emp_data['jd']))." href=".$emp_data['jd']." class='fa fa-file'></a>";} else echo "---";?> 
                    </td>
					<td><?php if(!empty($emp_data['cv'])) {echo "<a download=".end(explode("/",$emp_data['cv']))." href=".$emp_data['cv']." class='fa fa-file'></a>";} else echo "---";?>                  
                    </td>
