  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/home/" class="brand-link">
      <img src="/public/img/icons/favicon.ico" alt="Logo" class="brand-image img-circle elevation-3"
           style="opacity: 1;max-height: 35px;background-color:white;">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <button id="logout" class="pull-right info" style="margin: auto;color: white;">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview ">
              <li class="nav-item" style="background-color: #343a40;">
                <a id="all_emp-link" href="/employee/" class="nav-link">
